...
export const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-20 lg:py-28 bg-white relative">
      ...
      {/* Background glow */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-blue-500/5 rounded-full blur-[140px] pointer-events-none"></div>
          ...
          {servicesData.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl bg-white border border-[#E5E7EB] p-8 flex flex-col justify-between hover:border-[#2563EB] hover:bg-[#F8FAFC] transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1"
              >
                <div>
                  {/* Top Icon & Number Badge */}
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-14 h-14 rounded-xl bg-[#EFF6FF] border border-[#E5E7EB] text-[#2563EB] flex items-center justify-center group-hover:scale-105 group-hover:bg-[#2563EB] group-hover:text-white transition-all duration-300 shadow-sm">
                  ...
                  <div className="space-y-2 pt-4 border-t border-[#E5E7EB] mb-6">
                    {service.features.map((feature, fIdx) => (
                      <div key={fIdx} className="flex items-center gap-2 text-xs text-[#6B7280] font-medium">
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold text-white bg-[#2563EB] hover:bg-blue-700 transition-all duration-200 shadow-sm"
                >
