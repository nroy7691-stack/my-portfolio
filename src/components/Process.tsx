...
export const Process: React.FC = () => {
  ...
  return (
    <section id="process" className="py-20 lg:py-28 bg-[#FFFFFF] relative">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <motion.div
                ...
                className="relative rounded-2xl bg-[#FFFFFF] border border-[#E2E8F0] p-6 flex flex-col justify-between hover:bg-[#F8FAFC] hover:border-[#2563EB] transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1 group"
              >
                <div>
                  {/* Step Number & Icon */}
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-3xl font-extrabold font-mono text-[#2563EB] group-hover:text-[#1D4ED8] transition-colors">
                      {step.number}
                    </span>
                    <div className="w-12 h-12 rounded-xl bg-[#EFF6FF] border border-[#E2E8F0] text-[#2563EB] group-hover:bg-[#2563EB] group-hover:text-white flex items-center justify-center transition-colors shadow-sm">
                  ...
                  {/* Description */}
                  <p className="text-sm font-semibold text-[#0F172A] mb-4 leading-relaxed">
                    {step.description}
                  </p>

                  {/* Details */}
                  <p className="text-xs text-[#475569] leading-relaxed border-t border-[#E2E8F0] pt-3">
                    {step.details}
                  </p>
                </div>

                <div className="mt-6 pt-2 text-[10px] font-mono text-[#475569] flex items-center gap-1 font-medium">
